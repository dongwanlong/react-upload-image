    ...
    <html>
       <head>
        ...
        <body>
            ...
            <div class="main">
                <div ng-include="'/apps/cloudvm/views/side-menu.html'"></div>
                <div class="content-wrapper">
                    <div ng-view="ng-view" class="content"></div>
                </div>
                <div class="clearfix"></div>
            </div>
            <script type="text/javascript" src="/javascripts/dist/require.min.js" data-main="/javascripts/apps/cloudvm/main.js"></script>
        </body>
    </html>
