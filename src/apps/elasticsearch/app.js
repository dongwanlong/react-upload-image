...
define([
    ...
    app.run(['WidgetService','esConfig','CommonLanguageService','LanguageService','HttpService','gEsStatus','$route', '$rootScope', '$http', '$location', 'routes','Config', 'CurrentContext',function (WidgetService, esConfig, CommonLanguageService, LanguageService, HttpService,gEsStatus, $route, $rootScope, $http, $location, routes,Config,CurrentContext) {
